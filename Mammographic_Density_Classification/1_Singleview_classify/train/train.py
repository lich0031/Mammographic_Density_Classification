...
from datasets import breast_classify_inbreast, Compose, Resize, ToTensor, Normalize, RandomHorizontallyFlip, RandomVerticallyFlip, RandomRotate
from models import resnet50, resnet34, resnet18, resnet101, resnet152,\
    resnet50se, resnet50_dilated, resnet50_dcse
...
def parse_args():
    ...
    parser.add_argument('--model_name', default='resnet50', type=str, help='unet, ...')
    ...
    parser.add_argument('--num_epoch', default=30, type=int, help='num epoch')
...
def Train(train_root, train_csv, test_csv):
    ...
    train_dataset = breast_classify_inbreast(root=train_root, csv_file=train_csv, transform=train_aug)
    test_dataset = breast_classify_inbreast(root=train_root, csv_file=test_csv, transform=test_aug)
...
if __name__ == "__main__":
    args = parse_args()
    train_root = '../JPG_INbreast_Adjusted/Images'
    csv_root = '../JPG_INbreast_Adjusted/Split_5fold'
