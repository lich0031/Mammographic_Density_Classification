...
def parse_args():
    ...
    parser.add_argument('--model_name', default='resnet50dcse', type=str, help='unet, ...')
...
def Train(train_root, train_csv, test_csv):
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        for batch_idx, (inputs1, inputs2, inputs3, inputs4, targets) in tqdm(enumerate(train_loader),
        ...
        for batch_idx, (inputs1, inputs2, inputs3, inputs4, targets) in tqdm(enumerate(test_loader),
...
if __name__ == "__main__":
    args = parse_args()
    train_root = '../../JPG_Hospital_Adjusted_Multiview'
    csv_root = '../../JPG_Hospital_Adjusted_Multiview/Split_5fold'
